...
import com.poum.cyclone.Adapter.MessageAdapter;
import com.poum.cyclone.Model.Chat;
import com.poum.cyclone.Model.User;
...
public class MessageActivity extends AppCompatActivity {
    ...
    ValueEventListener seenListerner;
    ...
    protected void onPause() {
        super.onPause();
        reference.removeEventListener(seenListerner);
        status("offline");
    }
